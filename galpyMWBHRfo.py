...
def MWBHRfo(ldeg, bdeg, dkpc):
    ...
    rforce1 = evaluateRforces(MWPotential2014wBH, Rpkpc/Rskpc,zkpc/Rskpc)*((Vs*1000.)**2.)/(Rskpc*par.kpctom) #m/ss

    rfsun = evaluateRforces(MWPotential2014wBH, Rskpc/Rskpc,0.0/Rskpc)*((Vs*1000.)**2.)/(Rskpc*par.kpctom) #m/ss
